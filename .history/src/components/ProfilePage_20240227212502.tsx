            ...
            <>
              ...
              <View style={styles.editableItemContainer}>
                ...
                {editableItem === 'dateOfBirth' ? (
                  <TouchableOpacity
                    onPress={() => setIsDateOfBirthEditMode(true)}
                ...
                {!isDateOfBirthEditMode && (
                  <Button
                    onPress={() => {
                      setEditableItem('dateOfBirth');
                      setIsDateOfBirthEditMode(true);
                    }}
                    title="Edit"
                  />
                )}
                {isDateOfBirthEditMode && (
                  <>
                    <DatePicker
                      modal
                      open={isDateOfBirthEditMode}
                      date={dateOfBirth}
                      onDateChange={setDateOfBirth}
                      mode="date"
                      onConfirm={date => {
                        setIsDateOfBirthEditMode(false);
                        setDateOfBirth(date);
                        handleUpdateProfile(); // Call the update function when confirming the date
                      }}
                    />
                    <Button
                      onPress={() => {

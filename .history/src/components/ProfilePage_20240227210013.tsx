          ...
          {userData ? (
            <>
              ...
              <View style={styles.editableItemContainer}>
                ...
                {!isEditMode && <Button onPress={() => { setEditableItem('surname'); setIsEditMode(true); }} title="Edit" />}
                {isEditMode && (
                  <>
                    <Button onPress={() => { setEditableItem(null); setIsEditMode(false); }} title="Cancel" />
                    <Button onPress={() => { setEditableItem(null); setIsEditMode(false); handleUpdateProfile(); }} title="Submit" />
                  </>
                )}
              </View>
              ...
              <View style={styles.editableItemContainer}>
                ...
                {!isEditMode && <Button onPress={() => setEditableItem('dateOfBirth')} title="Edit" />}
                {isEditMode && <Button onPress={() => { setEditableItem(null); handleUpdateProfile(); }} title="Submit" />}
              </View>
              ...
              <View style={styles.editableItemContainer}>
                ...
                {!isEditMode && <Button onPress={() => setEditableItem('currentYear')} title="Edit" />}
                {isEditMode && <Button onPress={() => { setEditableItem(null); handleUpdateProfile(); }} title="Submit" />}
              </View>
              <View style={styles.editableItemContainer}>
                ...
                {!isEditMode && <Button onPress={() => setEditableItem('house')} title="Edit" />}
                {isEditMode && <Button onPress={() => { setEditableItem(null); handleUpdateProfile(); }} title="Submit" />}
              </View>
